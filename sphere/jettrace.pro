...
; E36 rot & acc
fn_e36_rot = 'jettrace_1e36_rot_cyl_93.sav'
;fn_e36_rot = 'jettrace_1e36_rot_cyl_177.sav'
...
fn_e36_acc = 'jettrace_1e36_578_smp2.sav'

restore,filename=fn_e36_rot & x2_36_rot = -jetposcyl[1,*] & z2_36_rot = jetposcyl[2,*]
restore,filename=fn_e36_acc & x2_36_acc = x2 & z2_36_acc = z2
zcrit_acc = 1.7e12
z2_36_acc_dummy = z2_36_acc
x2_36_acc = x2_36_acc[where(z2_36_acc_dummy le zcrit_acc)]
z2_36_acc = z2_36_acc[where(z2_36_acc_dummy le zcrit_acc)]
...
; E37 data 
fn_e37_1   = 'jettrace_1e37_463_smp3.sav'
fn_e37_2   = 'jettrace_1e37_463_smp4.sav'
...
; E37 gam166 data
fn_e37_g5_1   = 'jettrace_1e37_gam166_382_smp3.sav'
fn_e37_g5_2   = 'jettrace_1e37_gam166_382_smp4.sav'
...
oplot,xjet_35,zjet_35, thick=4
oplot,x2_36,z2_36,psym=dsym(5),color=50,symsize=0.5
oplot,xjet_36,zjet_36,color=50, thick=4
oplot,x2_37,z2_37,psym=dsym(8),color=200,symsize=0.5
oplot,xjet_37,zjet_37,color=254, thick=4

oplot,x2_37_g5,z2_37_g5,psym=dsym(8),color=254,symsize=0.5
;oplot,xjet_37_g5,zjet_37_g5,color=200


;oplot,!x.crange,[4.8e12,4.8e12],line=3
;oplot,!x.crange,[4.3e12,4.3e12],line=3
;oplot,!x.crange,[3.2e12,3.2e12],line=3
;oplot,!x.crange,[2.9e12,2.9e12],line=3
;oplot,[-4.e12,-4.e12],!y.crange,line=3
;oplot,[-3.6e12,-3.6e12],!y.crange,line=3
;oplot,[-3.1e12,-3.1e12],!y.crange,line=3
;oplot,[-3.3e12,-3.3e12],!y.crange,line=3
;oplot,!x.crange,[3.2e12,3.2e12],line=3
;oplot,!x.crange,[2.9e12,2.9e12],line=3
; eliminate bad pixels
x2_36_rot_tmp = x2_36_rot & z2_36_rot_tmp = z2_36_rot
x2_36_rot_tmp[where((x2_36_rot ge -3.3e12) and (x2_36_rot le -3.1e12)   $
                and (z2_36_rot ge 2.9e12) and (z2_36_rot le 3.2e12))] = !values.f_nan
z2_36_rot_tmp[where((x2_36_rot ge -3.3e12) and (x2_36_rot le -3.1e12)   $
                and (z2_36_rot ge 2.9e12) and (z2_36_rot le 3.2e12))] = !values.f_nan
x2_36_rot_tmp[where(z2_36_rot ge 4.3e12)] = !values.f_nan
z2_36_rot_tmp[where(z2_36_rot ge 4.3e12)] = !values.f_nan
x2_36_rot = x2_36_rot[where(finite(x2_36_rot_tmp))]
z2_36_rot = z2_36_rot[where(finite(x2_36_rot_tmp))]
...
xc0=1.e12 & yc0=0.
xc1=!x.crange[0]
oplot,[xc0,xc1],[yc0, -tan(24*!dtor)*(xc1-xc0)+yc0],line=2
...
case Lj of
   1e35: h0=4.5e10
   1e36: h0=6.5e10
   1e37: h0=5.e10 ;if keyword_set(gam53) then h0=5e10 else h0=5e10
...
xjet_36_dummy = xjet_36
xjet_36[where(xjet_36_dummy le -4.5e12)] = !values.f_nan
zjet_36[where(xjet_36_dummy le -4.5e12)] = !values.f_nan
intpx36[where(xjet_36_dummy le -4.5e12)] = !values.f_nan
...
if not keyword_set(ps) then begin
   !p.background=255 & !p.color=0
   window,1
endif else mkeps,'jettrace_errorchk',xs=20.,ys=20.*6./8.
...
oplot,ang_36+4, dev36/abs(xjet_36),color=50, line=3
...
oplot,[20.,20.],!y.crange,line=0, thick=3
legend,'SphWind_'+['E35','E36','E37','E36_rot'],color=[0,50,250,100],textcolor=[0,50,250,100] $
      ,box=0,/right,/bottom, charsize=1., line=[2,3,4,5]
