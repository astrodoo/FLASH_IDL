...
rho0 = 1.67d-24 *10.   ; ambient density
...
fname = 'PWN2d_hdf5_plt_cnt_0500_dl0.7'
outf  = 'analBow2_0500_10.sav'
xra=[0.,3.e16]
yra=[-5.e15,7.e16]
sample=1
...
if mkdata then begin
   ...
   save,file=outf,x,w1,R_b,pos
   ;save,file='analBow_0180_gam34.dat',x,w1,w2,R_b,pos
;   save,file='analBow.dat',x,w1,R_b,pos
endif else restore, file=outf
...
tvlct, r,g,b,/get
if keyword_Set(ps) then mkeps, 'analBow2', xs=20., ys=20.*(sz[0]+100)/(sz[1]+300) $
